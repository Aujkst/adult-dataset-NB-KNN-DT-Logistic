...
if __name__ == "__main__":
    ...
    #estimator = LogisticRegression( max_iter=10,random_state=seed)
    #estimator = LogisticRegression( max_iter=20,random_state=seed)

    estimator = LogisticRegression( tol=1e-4,random_state=seed)
    #estimator = LogisticRegression( tol=1e-1,random_state=seed)
